...
// function HomePage() {
// JSX
// GlobalStyle faz ficar com fundo preto
// return (
//   <div> 
//     <GlobalStyle/> 
    ...
    <>
      <Box
        styleSheet={{
          ...
          backgroundImage: 'url(https://i.redd.it/7i84h5a5wriy.png)',
      ...
      >
        <Box
          styleSheet={{
            ...
            backgroundColor: "rgba(30, 75, 30, 0.55)",
          }}
        >
          {/* Formulário */}
          <Box
            ...
            onSubmit={function (infosDoEvento) {
             ...
             // uma maneira padrão que troca de pagina é
              // window.location.href = '/chat';
              // porem essa maneira faz a pagina ter um leve refreash procurando dados
          ...
          >
            <Titulo tag="h2">ALURACORD</Titulo>
